                ...
                <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: '4px' }}>
                   ...
                   {dayPresets.includes(wh.days) || !wh.days ? (
                     ...
                     <div style={{ display: 'flex', gap: '4px' }}>
                       ...
                       <Button variant="secondary" size="icon" aria-label="Reset day to Monday - Friday" title="Reset day to Monday - Friday" onClick={(e) => { e.preventDefault(); updateField("days", "Monday - Friday"); }}>↺</Button>
                     </div>
                   )}
                </div>
