                      ...
                      {isEditing ? (
                        ...
                        <div className="row-action-group">
                          ...
                          <div className="dropdown-container" ref={menuOpenIdx === i ? menuRef : null}>
                            <button className="action-btn" aria-label="More actions" aria-haspopup="menu" aria-expanded={menuOpenIdx === i} onClick={(e) => { e.stopPropagation(); setMenuOpenIdx(menuOpenIdx === i ? null : i); }}>
