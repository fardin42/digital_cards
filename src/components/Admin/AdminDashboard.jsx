                      ...
                      {isEditing ? (
                        ...
                        <div className="row-action-group">
                          ...
                          <div className="dropdown-container" ref={menuOpenIdx === i ? menuRef : null}>
                            <button className="action-btn" aria-label="Actions menu" aria-haspopup="true" aria-expanded={menuOpenIdx === i} onClick={(e) => { e.stopPropagation(); setMenuOpenIdx(menuOpenIdx === i ? null : i); }}>
