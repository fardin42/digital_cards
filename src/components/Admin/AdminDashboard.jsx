    ...
    <div className="admin-layout">
      ...
      <aside className="admin-sidebar">
        <div className="sidebar-header">
          ...
          <button className="sidebar-back-btn" onClick={() => setView('home')} title="Back to site" aria-label="Back to home">
            <ArrowLeft size={18} />
          </button>
        </div>
                        ...
                        <div className="row-action-group">
                          ...
                          {card && (
                            <button
                              ...
                              aria-label={card.status === 'active' ? `Suspend ${client.name}'s card` : `Activate ${client.name}'s card`}
                            >
                          ...
                          <div className="dropdown-container" ref={menuOpenIdx === i ? menuRef : null}>
                            <button className="action-btn" aria-label={`More actions for ${client.name}`} aria-haspopup="true" aria-expanded={menuOpenIdx === i} onClick={(e) => { e.stopPropagation(); setMenuOpenIdx(menuOpenIdx === i ? null : i); }}>
