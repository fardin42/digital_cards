                      ...
                      {isEditing ? (
                        ...
                        <div className="row-action-group">
                          ...
                          <div className="dropdown-container" ref={menuOpenIdx === i ? menuRef : null}>
                            <button aria-label={`Actions for ${client.name || 'client'}`} aria-haspopup="menu" aria-expanded={menuOpenIdx === i} className="action-btn" onClick={(e) => { e.stopPropagation(); setMenuOpenIdx(menuOpenIdx === i ? null : i); }}>
