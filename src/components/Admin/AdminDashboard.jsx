                    ...
                    <td className="actions-cell">
                      {isEditing ? (
                        <div className="edit-actions">
                          <button className="btn-save-edit" onClick={() => handleSaveEdit(client)} title="Save" aria-label="Save edits"><Save size={16} /></button>
                          <button className="btn-cancel-edit" onClick={() => setEditingIdx(null)} title="Cancel" aria-label="Cancel edits"><X size={16} /></button>
                        </div>
                      ) : (
                        <div className="row-action-group">
                          ...
                          <div className="dropdown-container" ref={menuOpenIdx === i ? menuRef : null}>
                            <button className="action-btn" onClick={(e) => { e.stopPropagation(); setMenuOpenIdx(menuOpenIdx === i ? null : i); }} title="Options" aria-label="Client options" aria-haspopup="true" aria-expanded={menuOpenIdx === i}>
