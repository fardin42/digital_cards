                    ...
                    <td className="actions-cell">
                      {isEditing ? (
                        <div className="edit-actions">
                          <button className="btn-save-edit" aria-label="Save edits" onClick={() => handleSaveEdit(client)} title="Save"><Save size={16} /></button>
                          <button className="btn-cancel-edit" aria-label="Cancel edits" onClick={() => setEditingIdx(null)} title="Cancel"><X size={16} /></button>
                        </div>
                      ) : (
                        <div className="row-action-group">
                          ...
                          {card && (
                            <button
                              ...
                              aria-label={`${card.status === 'active' ? 'Suspend' : 'Activate'} card for ${client.name || 'client'}`}
                          ...
                          <div className="dropdown-container" ref={menuOpenIdx === i ? menuRef : null}>
                            <button className="action-btn" aria-label={`Actions for ${client.name || 'client'}`} onClick={(e) => { e.stopPropagation(); setMenuOpenIdx(menuOpenIdx === i ? null : i); }}>
