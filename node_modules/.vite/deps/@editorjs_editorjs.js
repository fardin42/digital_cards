...
var S = Ie.bind(window, !1), X = Ie.bind(window, !0);
function le(n) {
...
var ft = "redactor dom changed", $o = "block changed", zo = "fake cursor is about to be toggled", Uo = "fake cursor have been set", Te = "editor mobile layout toggled";
function gt(n, e) {
...
var R = class R extends Oe {
	...
	*/
	detectToolRootChange(e) {
		e.forEach((t) => {
			if (Array.from(t.removedNodes).includes(this.toolRenderedElement)) this.toolRenderedElement = t.addedNodes[t.addedNodes.length - 1];
		});
	}
	/**
...
var nt = ne("ce-popover-item-separator"), it = {
	container: nt(),
	line: nt("line"),
...
var To = ne("ce-popover-item-html"), So = {
	root: To(),
...
var ps = on;
var at = ne("ce-popover-header"), lt = {
	root: at(),
	text: at("text"),
...
var Cs = class extends E {
	...
	*/
	async open() {
		...
		this.popover = new hs({
			items: await this.getPopoverItems(),
			scopeElement: this.Editor.API.methods.ui.nodes.redactor,
			messages: {
				nothingFound: z.ui(K.ui.popover, "Nothing found"),
				search: z.ui(K.ui.popover, "Filter")
...
var _o = "block-removed", Mo = "block-added", ia = "block-moved", Ao = "block-changed";
var sa = class {
	constructor() {
		this.completed = Promise.resolve();
	}
	...
	processPlain(e) {
		...
		return e.split(/\r?\n/).filter((i) => i.trim()).map((i) => {
			...
			return {
				...
				tool: o,
				isBlock: !1,
				event: this.composePasteEvent("tag", { data: s })
			};
		});
	}
	/**
...
var fo = class fo {
	...
	*/
	onPaste(e) {
		this._data = { text: e.detail.data.innerHTML }, window.requestAnimationFrame(() => {
...
var j = class j extends Map {
	...
	*/
	get blockTools() {
		return new j(Array.from(this.entries()).filter(([, t]) => t.isBlock()));
	}
	/**
	* Returns Inline Tools collection
	*/
	get inlineTools() {
		return new j(Array.from(this.entries()).filter(([, t]) => t.isInline()));
	}
	/**
	* Returns Block Tunes collection
	*/
	get blockTunes() {
		return new j(Array.from(this.entries()).filter(([, t]) => t.isTune()));
	}
	/**
	* Returns internal Tools collection
	*/
	get internalTools() {
		return new j(Array.from(this.entries()).filter(([, t]) => t.isInternal));
	}
	/**
