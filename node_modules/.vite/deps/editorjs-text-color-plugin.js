...
//#region node_modules/editorjs-text-color-plugin/dist/bundle.js
var require_bundle = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	(function(t, e) {
		...
		var t = {
						...
						return this.map((function(e) {
							var n = function(t, e) {
								...
								if (e && "function" == typeof btoa) {
									var l = (n = r, o = btoa(unescape(encodeURIComponent(JSON.stringify(n)))), i = "sourceMappingURL=data:application/json;charset=utf-8;base64,".concat(o), "/*# ".concat(i, " */")), a = r.sources.map((function(t) {
			...
			138: (t, e, n) => {
				const o = n(442), { markerIcon: i, textIcon: s } = n(452), { getDefaultColorCache: r, handleCSSVariables: l } = n(697);
			...
			442: (t, e, n) => {
				...
				class c extends HTMLElement {
					...
					connectedCallback() {
						this.popoverEle = this.shadowRoot.getElementById("popover"), this.popcon = this.shadowRoot.getElementById("popcon"), this.colorBtn = this.shadowRoot.getElementById("color-btn"), this.colors = this.shadowRoot.getElementById("colors"), this.colors.addEventListener("click", ((t) => {
					...
					closeConverter() {
						if (document.getElementsByClassName(l.CONVERTER_PANEL)[0]) document.getElementsByClassName(l.CONVERTER_BTN)[0]?.click();
					}
					...
					attributeChangedCallback(t, e, n) {
						"disabled" == t && this.colorBtn && (null != n ? this.colorBtn.setAttribute("disabled", "disabled") : this.colorBtn.removeAttribute("disabled")), "dir" == t && this.popoverEle && null != n && (this.popoverEle.dir = n);
					}
				}
