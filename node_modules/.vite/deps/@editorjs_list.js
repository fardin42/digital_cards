...
function Mt(e) {
	var t = window.getComputedStyle(e), n = parseFloat(t.fontSize), r = parseFloat(t.lineHeight) || n * 1.2, i = parseFloat(t.paddingTop), a = parseFloat(t.borderTopWidth), l = parseFloat(t.marginTop), s = n * .8, o = (r - n) / 2;
	return l + a + i + o + s;
}
(function(e) {
...
function X(e, ...t) {
	...
	const n = t.shift();
	if (M(e) && M(n)) for (const r in n) M(n[r]) ? (e[r] === void 0 && Object.assign(e, { [r]: {} }), X(e[r], n[r])) : Object.assign(e, { [r]: n[r] });
	return X(e, ...t);
}
function Jt(e, t, n) {
...
var le = /* @__PURE__ */ wt(/* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
	__proto__: null,
	PromiseQueue: tn,
	beautifyShortcut: Ft,
	cacheable: Wt,
...
var z = class {
	...
	*/
	splitItem(t) {
		...
		t?.after(s), l && s.appendChild(l), E(s);
	}
	/**
	...
	*/
	renderItem(t, n) {
		...
		switch (!0) {
			case this.renderer instanceof v: return this.renderer.renderItem(t, r);
			case this.renderer instanceof b: return this.renderer.renderItem(t, r);
